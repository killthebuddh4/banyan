...
import { createClient as declineChannelInviteCreateClient } from "../../xgc/actions/decline-channel-invite/createClient.js";
import { createClient as inviteMemberToChannelCreateClient } from "../../xgc/actions/invite-member-to-channel/createClient.js";
import { CONFIG } from "../lib/CONFIG.js";

describe("3", () => {
  it("decline invite to a channel", async function () {
    ...
    const declineClient = declineChannelInviteCreateClient({
    ...
    const withDeclinedInvites = await dccc({
      channelAddress: created.result.createdChannelAddress,
    });

    logGood(withDeclinedInvites);
  });
});
